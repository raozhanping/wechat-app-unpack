...
define('page/API/pages/canvas/example.js', function (
  require,
  module,
  exports,
  window,
    ...
    ;(e.rotate = function (e) {
      ...
      (e.reset = function (e) {
        e.beginPath(),
          ...
          e.setStrokeStyle('#000000'),
          e.setFontSize(10),
          e.setShadow(0, 0, 0, 'rgba(0, 0, 0, 0)'),
          e.setLineCap('butt'),
          e.setLineJoin('miter'),
          e.setLineWidth(1),
          e.setMiterLimit(10)
      ...
      (e.save = function (e) {
        e.beginPath(),
          e.setStrokeStyle('#00ff00'),
          e.save(),
          e.scale(2, 2),
          e.setStrokeStyle('#ff0000'),
          e.rect(0, 0, 100, 100),
          e.stroke(),
          e.restore(),
          e.rect(0, 0, 50, 50),
      ...
      (e.fillText = function (e) {
        e.setStrokeStyle('#ff0000'),
          ...
          e.stroke(),
          e.setFontSize(10),
          e.fillText('Hello World', 0, 30),
          e.setFontSize(20),
          e.fillText('Hello World', 100, 30),
          e.beginPath(),
          e.moveTo(0, 30),
          e.lineTo(300, 30),
          e.stroke()
      ...
      (e.arc = function (e) {
        e.beginPath(),
          ...
          e.moveTo(110, 75),
          e.arc(75, 75, 35, 0, Math.PI, !1),
          e.moveTo(65, 65),
          e.arc(60, 65, 5, 0, 2 * Math.PI, !0),
          e.moveTo(95, 65),
          e.arc(90, 65, 5, 0, 2 * Math.PI, !0),
          e.stroke()
      }),
      ...
      (e.setGlobalAlpha = function (e) {
        e.setFillStyle('#000000'),
          [1, 0.5, 0.1].forEach(function (t, o) {
      ...
      (e.setLineCap = function (e) {
        e.setLineWidth(10),
          ['butt', 'round', 'square'].forEach(function (t, o) {
            e.beginPath(), e.setLineCap(t), e.moveTo(20, 20 + 20 * o), e.lineTo(100, 20 + 20 * o), e.stroke()
          })
      }),
      (e.setLineJoin = function (e) {
        e.setLineWidth(10),
          ['bevel', 'round', 'miter'].forEach(function (t, o) {
            e.beginPath(),
              e.setLineJoin(t),
              e.moveTo(20 + 80 * o, 20),
              e.lineTo(100 + 80 * o, 50),
              e.lineTo(20 + 80 * o, 100),
              e.stroke()
          })
      }),
...
define('page/API/pages/custom-service/custom-service.js', function (
  require,
  module,
  exports,
  window,
...
define('page/API/pages/sendMessage/sendMessage.js', function (
  require,
  module,
  exports,
  window,
...
define('util/util.js', function (
  ...
  !(function () {
    ...
    function r(t, r) {
      return (
        'string' == typeof t && 'string' == typeof r && ((t = parseFloat(t)), (r = parseFloat(r))),
        (t = t.toFixed(2)),
        (r = r.toFixed(2)),
        {
...
define('vendor/qcloud-weapp-client-sdk/index.js', function (
  require,
  module,
  exports,
  window,
...
define('vendor/qcloud-weapp-client-sdk/lib/constants.js', function (
  require,
  module,
  exports,
  window,
...
define('vendor/qcloud-weapp-client-sdk/lib/login.js', function (
  require,
  module,
  exports,
  window,
    ...
    var e = require('./utils'),
      ...
      u = function (o) {
        if (((o = e.extend({}, t, o)), !t.loginUrl))
          return void o.fail(
            new r(n.ERR_INVALID_PARAMS, '登录错误：缺少登录地址，请通过 setLoginUrl() 方法设置登录地址'),
          )
        var u = function () {
            return s(function (e, s) {
              ...
              var t = s.userInfo,
                ...
                l = s.iv,
                a = {}
              ;(a[n.WX_HEADER_CODE] = u),
                (a[n.WX_HEADER_ENCRYPTED_DATA] = c),
                (a[n.WX_HEADER_IV] = l),
                wx.request({
                  url: o.loginUrl,
                  header: a,
...
define('vendor/qcloud-weapp-client-sdk/lib/request.js', function (
  require,
  module,
  exports,
  window,
            ...
            success: function (e) {
              ...
              if (r && r[o.WX_SESSION_MAGIC_ID]) {
                ...
                if (r.error === o.ERR_INVALID_SESSION) {
                  ...
                  (i = '鉴权服务器检查登录态发生错误(' + (r.error || 'OTHER') + ')：' + (r.message || '未知错误')),
                    (t = new c(o.ERR_CHECK_LOGIN_FAILED, i))
                return void m(t)
              }
...
define('vendor/qcloud-weapp-client-sdk/lib/session.js', function (
  require,
  module,
  exports,
  window,
...
define('vendor/qcloud-weapp-client-sdk/lib/tunnel.js', function (
  require,
  module,
  exports,
  window,
  ...
  !(function () {
    ...
    function t(p) {
      ...
      function x(t) {
        var n = [t.type]
        t.content && n.push(JSON.stringify(t.content)),
      ...
      function Y(t) {
        ut >= rt
          ...
          : (wx.closeSocket(), (at += ft), _(u), (lt = setTimeout(z, at))),
          0 === ut && y('reconnecting'),
          (ut += 1)
      }
...
define('vendor/qcloud-weapp-client-sdk/lib/utils.js', function (
  require,
  module,
  exports,
  window,
...
define('vendor/qcloud-weapp-client-sdk/lib/wxTunnel.js', function (
  require,
  module,
  exports,
  window,
          ...
          : wx.login({
              success: function (e) {
                wx.request({
                  ...
                  success: function (o) {
                    console.log('拉取openid成功', o),
                      (l.globalData.openid = o.data.openid),
                      n(null, l.globalData.openid)
                  },
                  fail: function (o) {
...
__wxRouteBegin = true
define('page/component/index.js', function (
  require,
  module,
  exports,
  window,
  ...
  !(function () {
    ...
    Page({
      ...
      kindToggle: function (e) {
        for (var a = e.currentTarget.id, i = this.data.list, n = 0, t = i.length; n < t; ++n)
          i[n].id == a ? (i[n].open = !i[n].open) : (i[n].open = !1)
        this.setData({
          list: i,
        })
      },
...
__wxRouteBegin = true
define('page/component/pages/view/view.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/scroll-view/scroll-view.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/swiper/swiper.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/text/text.js', function (
  require,
  module,
  exports,
  window,
  ...
  !(function () {
    ...
    Page({
      ...
      add: function (e) {
        var n = this
        this.extraLine.push(t[this.extraLine.length % 12]),
          this.setData({
...
__wxRouteBegin = true
define('page/component/pages/icon/icon.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/progress/progress.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/button/button.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/checkbox/checkbox.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/form/form.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/input/input.js', function (
  require,
  module,
  exports,
  window,
    ...
    Page({
      ...
      bindReplaceInput: function (e) {
        var a,
          ...
          u = e.detail.cursor
        return (
          -1 !== u && ((a = e.detail.value.slice(0, u)), (u = a.replace(/11/g, '2').length)),
          {
...
__wxRouteBegin = true
define('page/component/pages/label/label.js', function (
  require,
  module,
  exports,
  window,
  ...
  !(function () {
    ...
    Page({
      ...
      checkboxChange: function (e) {
        for (var a = e.detail.value, t = {}, c = 0; c < this.data.checkboxItems.length; c++)
          -1 !== a.indexOf(this.data.checkboxItems[c].name)
            ? (t['checkboxItems[' + c + '].checked'] = !0)
            : (t['checkboxItems[' + c + '].checked'] = !1)
        this.setData(t)
      },
      radioChange: function (e) {
        for (var a = e.detail.value, t = {}, c = 0; c < this.data.radioItems.length; c++)
          -1 !== a.indexOf(this.data.radioItems[c].name)
            ? (t['radioItems[' + c + '].checked'] = !0)
            : (t['radioItems[' + c + '].checked'] = !1)
        this.setData(t)
      },
      tapEvent: function (e) {
        console.log('按钮被点击')
...
__wxRouteBegin = true
define('page/component/pages/picker/picker.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/radio/radio.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/slider/slider.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/switch/switch.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/textarea/textarea.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/navigator/navigator.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/navigator/navigate.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/navigator/redirect.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/image/image.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/audio/audio.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/video/video.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/map/map.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/component/pages/canvas/canvas.js', function (
  require,
  module,
  exports,
  window,
  ...
  !(function () {
    ...
    Page({
      ...
      drawBall: function () {
        function t(t, a) {
          n.beginPath(0),
            n.arc(t, a, 5, 0, 2 * Math.PI),
            n.setFillStyle('#1aad19'),
            n.setStrokeStyle('rgba(1,1,1,0)'),
            n.fill(),
            n.stroke()
        }
        var a = this.position
...
__wxRouteBegin = true
define('page/API/index.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/login/login.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/get-user-info/get-user-info.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/request-payment/request-payment.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/share/share.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/share-button/share-button.js', function (
  require,
  module,
  exports,
  window,
  ...
  !(function () {
    ...
    Page({
      ...
      handleTapShareButton: function () {
        ;('function' == typeof wx.canIUse && wx.canIUse('button.open-type.share')) ||
          wx.showModal({
            title: '当前版本不支持转发按钮',
...
__wxRouteBegin = true
define('page/API/pages/custom-message/custom-message.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/template-message/template-message.js', function (
  require,
  module,
  exports,
  window,
          ...
          o.getUserOpenId(function (o, s) {
            o
              ...
              : wx.request({
                  ...
                  success: function (e) {
                    console.log('submit form success', e),
                      wx.showToast({
                        title: '发送成功',
                        icon: 'success',
                      }),
...
__wxRouteBegin = true
define('page/API/pages/set-navigation-bar-title/set-navigation-bar-title.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/navigation-bar-loading/navigation-bar-loading.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/navigator/navigator.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/pull-down-refresh/pull-down-refresh.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/animation/animation.js', function (
  require,
  module,
  exports,
  window,
  ...
  !(function () {
    ...
    Page({
      ...
      rotate: function () {
        this.animation.rotate(720 * Math.random() - 360).step(),
          this.setData({
            animation: this.animation.export(),
          })
      },
      scale: function () {
        this.animation.scale(2 * Math.random()).step(),
          this.setData({
            animation: this.animation.export(),
          })
      },
      ...
      skew: function () {
        this.animation.skew(90 * Math.random(), 90 * Math.random()).step(),
          this.setData({
            animation: this.animation.export(),
          })
      },
      ...
      all: function () {
        this.animation
          .rotate(720 * Math.random() - 360)
          .scale(2 * Math.random())
          .translate(100 * Math.random() - 50, 100 * Math.random() - 50)
          .skew(90 * Math.random(), 90 * Math.random())
          .step(),
          this.setData({
            animation: this.animation.export(),
          })
...
__wxRouteBegin = true
define('page/API/pages/action-sheet/action-sheet.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/modal/modal.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/toast/toast.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/get-network-type/get-network-type.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/on-network-status-change/on-network-status-change.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/get-system-info/get-system-info.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/on-compass-change/on-compass-change.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/make-phone-call/make-phone-call.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/scan-code/scan-code.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/request/request.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/web-socket/web-socket.js', function (
  require,
  module,
  exports,
  window,
      ...
      openSocket: function () {
        ...
        c.on('connect', function () {
          ...
          c.on('error', function (o) {
            t('发生错误', JSON.stringify(o)),
              console.error('socket error:', o),
              s.setData({
                loading: !1,
              })
          }),
...
__wxRouteBegin = true
define('page/API/pages/upload-file/upload-file.js', function (
  require,
  module,
  exports,
  window,
        ...
        wx.chooseImage({
          ...
          success: function (o) {
            ...
            wx.uploadFile({
              ...
              name: 'data',
              success: function (e) {
                console.log('uploadImage success, res is:', e),
                  wx.showToast({
                    title: '上传成功',
                    icon: 'success',
                    duration: 1e3,
...
__wxRouteBegin = true
define('page/API/pages/download-file/download-file.js', function (
  require,
  module,
  exports,
  window,
    ...
    Page({
      downloadImage: function () {
        ...
        wx.downloadFile({
          url: o,
          success: function (o) {
            console.log('downloadFile success, res is', o),
              e.setData({
...
__wxRouteBegin = true
define('page/API/pages/image/image.js', function (
  require,
  module,
  exports,
  window,
  ...
  !(function () {
    'use strict'
    var e = [['camera'], ['album'], ['camera', 'album']],
...
__wxRouteBegin = true
define('page/API/pages/voice/voice.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/file/file.js', function (
  require,
  module,
  exports,
  window,
          ...
          wx.saveFile({
            ...
            success: function (e) {
              t.setData({
                ...
                wx.setStorageSync('savedFilePath', e.savedFilePath),
                t.setData({
                  dialog: {
                    title: '保存成功',
...
__wxRouteBegin = true
define('page/API/pages/on-accelerometer-change/on-accelerometer-change.js', function (
  require,
  module,
  exports,
  window,
  ...
  !(function () {
    ...
    Page({
        ...
        ;(this.position = {
          ...
          wx.onAccelerometerChange(function (t) {
            a.setData({
              ...
              (a.position.ax = Math.sin((t.x * Math.PI) / 2)),
              (a.position.ay = -Math.sin((t.y * Math.PI) / 2))
          }),
      ...
      drawBigBall: function () {
        ...
        a.beginPath(0),
          a.arc(151, 151, 140, 0, 2 * Math.PI),
          a.setFillStyle('#ffffff'),
          a.setStrokeStyle('#aaaaaa'),
          a.fill(),
          wx.drawCanvas({
            canvasId: 'big-ball',
      ...
      drawSmallBall: function () {
        ...
        ;(a.x = a.x + a.vx),
          ...
          (a.vx = a.vx + a.ax),
          (a.vy = a.vy + a.ay),
          Math.sqrt(Math.pow(Math.abs(a.x) - 151, 2) + Math.pow(Math.abs(a.y) - 151, 2)) >= 115 &&
            (a.x > 151 && a.vx > 0 && (a.vx = 0),
            a.x < 151 && a.vx < 0 && (a.vx = 0),
            a.y > 151 && a.vy > 0 && (a.vy = 0),
            a.y < 151 && a.vy < 0 && (a.vy = 0),
            (t = '#ff0000'))
        var e = wx.createContext()
        e.beginPath(0),
          e.arc(a.x, a.y, 15, 0, 2 * Math.PI),
          e.setFillStyle('#1aad19'),
          e.setStrokeStyle(t),
          e.fill(),
          wx.drawCanvas({
            canvasId: 'small-ball',
...
__wxRouteBegin = true
define('page/API/pages/canvas/canvas.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/background-audio/background-audio.js', function (
  require,
  module,
  exports,
  window,
    ...
    Page({
      onLoad: function () {
        this._enableInterval(),
          a.globalData.backgroundAudioPlaying &&
            this.setData({
              playing: !0,
            })
      },
      ...
      play: function (t) {
        ...
        wx.playBackgroundAudio({
          ...
          this._enableInterval(),
          (a.globalData.backgroundAudioPlaying = !0)
      },
      seek: function (a) {
...
__wxRouteBegin = true
define('page/API/pages/video/video.js', function (
  require,
  module,
  exports,
  window,
  ...
  !(function () {
    'use strict'
    var a = [['camera'], ['album'], ['camera', 'album']],
...
__wxRouteBegin = true
define('page/API/pages/get-location/get-location.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/open-location/open-location.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/choose-location/choose-location.js', function (
  require,
  module,
  exports,
  window,
...
__wxRouteBegin = true
define('page/API/pages/storage/storage.js', function (
  require,
  module,
  exports,
  window,
